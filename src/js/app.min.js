...
// Link do PDF/Portfolio
const LINK_PORFTOLIO = "https://drive.google.com/file/d/1FVuxAYfczUXDnfkIXxvsxla9zPbMQvpj/view";
...
document.querySelectorAll(".js-vermais").forEach((el) => {
  el.setAttribute("href", LINK_PORFTOLIO);
});
